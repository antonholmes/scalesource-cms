...
Trying a Sanity.io CMS for ScaleSource App.
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/f6rdy0cw/settings/api) and create a token with read rights.
